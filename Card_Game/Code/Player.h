...
public:
  ...
  // Depending on whether the player is a computer or human player, use
  // different code: If the player is computer, i.e., the name of the player is
  // "computer":
...
private:
  ...
  bool played[Max_Cards];  // played[i] indicates if hand[i] has a card or not.
                           //  make sure to initialize the values to "false"
};
